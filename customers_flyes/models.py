...
class Customer(models.Model):
	...
	birth_date = models.DateField('Fecha de nacimiento', auto_now_add=True)
...
# 	# fly_date = models.DateTimeField('Fecha del Vuelo', datetime=)
# 	seat_number = models.IntegerField('Numero de asiento', null=False)
# 	rute = models.CharField('Ruta', null=False)
# 	def __unicode_(self):
